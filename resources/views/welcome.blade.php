...
<main class="flex flex-col overflow-hidden">
    ...
    <div class="container mx-auto h-120"         style="background-image: url('{{ asset('images/neptunas.png') }}'); background-size: cover; background-repeat: no-repeat; background-position: center;">
        <div class="px-[75px] py-10 w-full">
            <div class="flex items-center">
                <div>
                    <h3
                    ...
                    <p class="text-[26px] font-bold text text-[#013538] pt-8">dzp is proudly supporting this brand and its events.</p>
                </div>
