        ...
        <nav class="flex items-center h-8 relative">
            <ul class="flex gap-8 text-base font-medium text-[#191919]">
                <div
                    ...
                    <div class="transition-transform duration-500 h-16"
...
<nav class="md:hidden sticky top-0 z-50">
    <div class="max-w-screen-xl flex items-center justify-between mx-auto pt-5 md:pt-10 px-6 relative">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            <div class="transition-transform duration-500 h-16 mobile-dzp-logo"
                 style="transform-origin: center;"
                 onmouseover="this.style.transform='rotate(180deg)'"
                 onmouseout="this.style.transform='rotate(0deg)'"/>
            <svg width="90" height="50" viewBox="0 0 180 104" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    >
        ...
        <nav class=" px-6 pt-14">
            <ul class=" font-semibold text-gray-900 dark:text-gray-300 flex flex-col">
                <li class="border-b-2 border-[#D8DFDE]] w-full">
                    <a href="#" class=" block px-4 text-[#191919] size-2xl rounded-md pb-8">Home</a>
                </li>
                <li class="border-b-2 border-[#D8DFDE]]">
                    <a href="#services" class=" block px-4 text-[#191919] size-2xl rounded-md pb-8">Services</a>
                </li>
                <li class="border-b-2 border-[#D8DFDE]]">
                    <a href="#" class=" block px-4 text-[#191919] size-2xl rounded-md pb-8">Pricing</a>
                </li>
                <li class="border-b-2 border-[#D8DFDE]]">
                    <a href="#" class=" block px-4 text-[#191919] size-2xl rounded-md pb-8">Contact</a>
                </li>
            </ul>
        </nav>
    </div>
