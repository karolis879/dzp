...
<div class="md:hidden flex flex-col container flex-start mb-[52px] mt-2 bg-[#E4E9E9] rounded-t-[24px] md:flex relative"
     id="contacts">
    <div class="flex flex-col w-full justify-between mt-1 pt-6  h-full">
        ...
        <div class="hidden bg-white h-[850px]" id="mobile-send-us-your-cv-form">
            test CV
        </div>
        <div class="hidden bg-white h-[850px]" id="mobile-general-contacts-section-form">
            test Contacts
        </div>
    </div>
</div>
