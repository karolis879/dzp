<div class=" container mx-auto flex-start md:mb-[52px] mb-4 mt-2 bg-[#E4E9E9] rounded-[24px] md:flex relative"
    ...
    <div
        ...
        <img src="{{asset('images/turbine_absolute.png')}}" data-aos="fade-up" data-aos-duration="1000" data-rjs="2"
                    ...
                    <div class="flex items-center gap-4 h-[70px] bg-white rounded-l-[60px] cursor-pointer"
                        ...
                        <div class="group pl-7">
                            <svg class="text-[#00403D]" width="36" height="36" viewBox="0 0 36 36" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M15 21H18M18 21H21M18 21V24M18 21V18" stroke="#00403D" stroke-width="3"
                    ...
                    <div class="flex flex-col items-start p-8">
                        ...
                        <div class="pt-10 w-full">
                            <form method="POST" action="{{ route('contact_us.send_cv') }}" enctype="multipart/form-data"
                                ...
                                <div class="w-full pt-7">
                                    <label for="cv" class="block text-2xl font-semibold mb-2">Attach your CV</label>
                                    ...
                                    <label for="cv"
                                        ...
                                        <div class="flex flex-col items-center text-center">
                                            ...
                                            <span id="file-name" class="pt-2 text-sm text-[#00403D] font-semibold"></span>
                                        </div>

                                        <input id="cv" name="cv" type="file" class="hidden" required>
                                    </label>
                                </div>
