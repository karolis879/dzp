...
{{--    <a href="https://redcross.lt/" target="_blank">--}}
{{--        <div--}}
...
{{--                <div class="hidden md:order-1 order-2 md:flex items-end w-1/2 md:w-1/4 font-thin">--}}
{{--                    <img src="{{ asset('images/comitee_hands.png') }}" class="w-[323px] h-[212px]" alt="hand_wing"/>--}}
{{--                </div>--}}
{{--                <div class="hidden order-1 md:order-3 w-1/4 md:flex items-center justify-center">--}}
...
{{--                    <h4 class="md:text-[#8EA2A0] text-[#627678] font-medium md:font-light text-[28px] md:text-[40px] md:leading-[50px]">--}}
{{--                        By Doing business with us--}}
{{--                        you support RED--}}
{{--                        CROSS organization!</h4>--}}
{{--                    <p class="text-left font-semibold  py-4">We are supporting financially all RED CROSS--}}
{{--                        activities in--}}
{{--                        Lithuania.</p>--}}
{{--                </div>--}}
{{--            </div>--}}
