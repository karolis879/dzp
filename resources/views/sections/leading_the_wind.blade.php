            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide relative">
                    <img src="{{ asset('images/hero.jpg') }}" alt="Wind Turbine"
                         class="hidden md:flex w-full md:h-[876px] object-cover rounded-[24px]"/>

                    <!-- Overlay content -->
                    <div class="absolute inset-0 flex flex-col items-center justify-between w-[750px] ml-auto h-full">
                        <div class=" py-43 px-2 flex flex-col items-center justify-between w-min h-full">
                            <div class="flex">
                                <h2 class="w-[180px] text-white text-[80px] md:text-6xl font-light drop-shadow-lg text-left">
                                    500 +
                                </h2>
                                <p class="w-[300px] text-white text-2xl text-left">Wind Turbines Serviced
                                    in last 365 days</p>
                            </div>
                            <div class="flex">
                                <h2 class="w-[180px] text-white text-[80px] text-left md:text-6xl font-light drop-shadow-lg">
                                    4 yrs
                                </h2>
                                <p class="w-[300px] text-white text-2xl text-left">Of innovations in the
                            ...
                            <div class="flex">
                                ...
                                <p class="w-[300px] text-white text-2xl text-left">In house, certified, professional
                                    rope access team.</p>
                            </div>
                            <div class="flex">
                                <h2 class="w-[180px] text-white text-[80px] text-left md:text-6xl font-light drop-shadow-lg">
                                ...
                                <p class="w-[300px] text-white text-2xl text-left">Low rotation of our employed rope
                                    access team.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-slide">
                    <img src="{{asset('images/hero_2.jpg')}}" alt="Wind Turbine"
                         class="hidden md:flex w-full md:h-[876px] object-cover rounded-[24px]"/>
                    <div class="p-18 absolute inset-0 flex flex-col items-end justify-end w-[900px] ml-auto h-full">
                        <div class="p-10">
                            <h2 class="text-6xl text-white pb-40">
                            ...
                            <div class="flex gap-20">
                                <div class="flex flex-col leading-none">
                                    <p class="text-[52px] font-light text-white">IRATA</p>
                                    <p class="text-[35px] font-light text-white">certified</p>
                                </div>

                                <p class="text-2xl text-white">In house employeed, professionals with extensive field experience.</p>
                            </div>
                        </div>
                    </div>
...
{{--                </div>--}}
                <div class="swiper-slide">
                    ...
                    <div class="p-18 absolute inset-0 flex flex-col items-end justify-end w-[900px] ml-auto h-full">
                        <div class="p-10">
                            <h2 class="text-6xl text-white pb-30">
...
<div
    class="container mx-auto flex justify-between items-center md:mt-[35px] mb-[52px] flex-col overflow-hidden relative">
