 <div class="flex flex-col w-full justify-between mt-1 pt-6  h-full md:hidden">
        <div class="flex h-full w-full justify-center items-center">
            <div class="w-1/3 flex flex-col items-center justify-center h-full pb-8 pt-4" id="mobile-contacts-section">
            ...
            <div class="w-1/3 flex flex-col items-center justify-center pb-8 pt-3 bg-white pt-6 rounded-t-[24px]"
                 id="mobile-quote-section">
                ...
                <p class="pt-3">Get a quote</p>
            </div>
            <div class="w-1/3 flex flex-col items-center pb-8 pt-2 pt-6" id="mobile-send-us-your-cv-section">
                ...
                <p class="pt-4">Send your CV</p>

            </div>
        </div>
        <div class="px-4 pt-5 w-full bg-white h-full md:h-[850px]" id="mobile-quote-section-form">
            <form method="POST" action="{{ route('contact_us.get_quote') }}" enctype="multipart/form-data"
                ...
                <div class="w-full flex flex-col pt-6 gap-7">
                    <button
                        type="submit"
        ...
        <div class="px-4 pt-5 hidden bg-white h-full" id="mobile-send-us-your-cv-form">
            <form method="POST" action="{{ route('contact_us.send_cv') }}" enctype="multipart/form-data"
                ...
                <div class="w-full pt-5">
                    <label for="profession" class="text-2xl font-semibold">Your
                        profession</label>
                ...
                <div class="w-full pt-5">
                    <label for="profession" class="text-2xl font-semibold">Country</label>
                    <input type="text" name="country" required placeholder="Enter your country"
                           class="w-full mt-4 border-[#191919] rounded-[14px]">
                </div>

                <div class="w-full pt-5">
                    <label for="mobile-cv" class="block text-2xl font-semibold mb-2">Attach your CV</label>

                    <label for="mobile-cv"
                           class="flex justify-center mt-4 items-center px-4 py-6 border-2 border-dashed border-gray-400 rounded-xl cursor-pointer text-center text-gray-600 hover:bg-gray-50 transition">

                        <div class="flex flex-col items-center text-center">
                            <span class="text-xl font-medium text-[#818181]">Please select file to upload</span>
                            <span class="text-base pt-2 font-light font-hankenGrotesk text-[#818181]">(PDF or DOC, max 3MB)</span>
                            <span id="mobile-file-name" class="pt-2 text-sm text-[#00403D] font-semibold"></span>
                        </div>

                        <input id="mobile-cv" name="cv" type="file" class="hidden" required>
                    </label>
                </div>

                <div class="w-full pt-5">
                    <label for="message" class="text-2xl font-semibold">Your motivation</label>
        ...
        <div class="px-4 pt-5 hidden bg-white h-full" id="mobile-general-contacts-section-form">
            <form method="POST" action="{{ route('contact_us.general_contacts') }}" enctype="multipart/form-data"
                  class="flex flex-col items-start ">
                @csrf
                <div class="w-full">
                    <label for="name" class="text-2xl font-semibold">Full
                ...
                <div class="w-full pt-5">
                    <label for="message" class="text-2xl font-semibold">Your message for us</label>
                    <input type="text" name="message" required placeholder="Enter details Your message here"
                           class="w-full mt-4 border-[#191919] rounded-[14px] h-24">
                </div>
